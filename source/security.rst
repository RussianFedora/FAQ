...
.. index:: LUKS, encryption, шифрование, change password, смена пароля
...
Здесь **/dev/sda** - зашифрованный раздел диска, а **0** - порядковый номер LUKS слота для пароля.
...
.. index:: LUKS, encryption, шифрование, drive information, информация о диске
.. _luks-info:
...
Здесь **/dev/sda** - зашифрованный раздел диска.

.. index:: LUKS, encryption, шифрование, производительность, performance
.. _luks-benchmark:
...
.. index:: LUKS, encryption, шифрование, производительность, performance, cpu
.. _luks-aes:
...
.. index:: ssh, password authentication
.. _ssh-passwords:
...
.. index:: ca, certificate, удостоверяющий центр
.. _add-custom-ca:
