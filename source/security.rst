...
По умолчанию в Fedora Workstation используется зона брандмауэра **FedoraWorkstation**, в которой разрешены все входящие соединения на порты из диапазона 1025-65535, как по TCP, так и UDP.
