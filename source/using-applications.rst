...
Произведём :ref:`очистку <plasma-mime-clean>` кэша :ref:`mime-типов <file-types>` файлов и каталогов и при необходимости :ref:`автоматизируем <plasma-mime-autoclean>` это действие.
