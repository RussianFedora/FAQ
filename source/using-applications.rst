...
Для работы с графическими файлами в формате `High Efficiency Image File <https://ru.wikipedia.org/wiki/HEIF>`__, подключим репозиторий :ref:`RPM Fusion <rpmfusion>` и установим пакет **libheif-hevc**:

.. code-block:: text

    sudo dnf install libheif-hevc
