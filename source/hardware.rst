...
Как переключаться между дискретной графикой NVIDIA и интегрированной графикой Intel на ноутбуках с поддержкой NVIDIA Optimus
============================================================================================================================
Установим необходимый модуль EnvyControl
...
Установим EnvyControl

.. code-block:: text

    sudo dnf install python3-envycontrol

Теперь необходимо установить `расширение <https://extensions.gnome.org/extension/5009/gpu-profile-selector/>`__, которое добавит выбор графики в меню действий. 

После переключения графики между Интегрированной/Гибридной/Дискретной **нужно обязательно подождать 2-3 минуты**, пока не появится окно, предлагающее перезапуск системы. После этого перезагрузите устройство, чтобы изменения вступили в силу.

**Внимание!** При переключении на интегрированную графику при загрузке системы появится ошибка ``NVIDIA kernel module missing. Falling back to nouveau.`` - это нормально, можете проигнорировать. При переключении на дискретную графику такой ошибки не будет.
