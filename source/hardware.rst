...
Для его активации пропишем следующие параметры ядра Linux:
...
Проверим работоспособность и выведем более подробные сведения о текущем режиме:

.. code-block:: text

    cpupower frequency-info

В случае если процессор не поддерживает данную технологию, будет использован традиционный механизм **acpi-cpufreq**.
