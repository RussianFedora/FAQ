...
После переключения графики между Интегрированной/Гибридной/Дискретной **нужно обязательно перезагрузить ваше устройство**, чтобы изменения вступили в силу.

**Внимание!** При переключении на интегрированную графику при загрузке системы появится ошибка **NVIDIA kernel module missing. Falling back to nouveau.** Не беспокойтесь, это нормально. При переключении на дискретную графику такой ошибки не будет.
