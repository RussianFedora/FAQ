...
ICC профиль можно получить у производителя устройства, извлечь из набора драйверов дисплея для Windows, либо найти готовый, созданный на специальном оборудовании.
