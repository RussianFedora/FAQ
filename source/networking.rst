...
Если продключение к VPN по протоколу PPTP не проходит из-за ошибки, включим поддержку протокола GRE внутри межсетевого экрана.
...
**Важно:** Некоторые интернет-провайдеры и бо́льшая операторов сотовой связи ограничивает передачу интернет-трафика по протоколу GRE. В случае, если вы уверены, что поставщик услуг связи здесь не при чем, обратите внимание на маршрутизатор: некоторые модели бюджетных устройств также могут ограничивать трафик.
