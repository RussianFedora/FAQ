...
Убедимся, что в качестве основного сервера DNS применяется виртуальная заглушка:
...
Теперь в :ref:`информации об используемых DNS <dns-crypt>` должна отображаться информация об использовании этой технологии.
