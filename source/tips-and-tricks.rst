...
Поскольку поддержка python2 прекратится 2020-01-01, его не следует использовать. Такая возможность появилась у пользователей начиная с Fedora 30. От python2 более не зависят важные системные компоненты и вы можете смело удалить:
