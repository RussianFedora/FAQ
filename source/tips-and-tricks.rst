...
Это `известная проблема <https://fedoraproject.org/wiki/Common_F30_bugs#GRUB_boot_menu_is_not_populated_after_an_upgrade>`__. Для её решения выполним следующую последовательность:

1. сразу после появления ошибки Grub 2 и перехода в emergency режим, выполним команду:

.. code-block:: text

    configfile /grub2/grub.cfg.rpmsave

2. после успешной загрузки, осуществим переустановку Grub 2 в MBR диска:
