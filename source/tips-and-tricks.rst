...
.. index:: libreoffice
.. _libreoffice-hwaccel:

Как устранить лаги при редактории документов, презентаций и таблиц в продуктах LibreOffice?
==============================================================================================
В случае испытывания лагов при работе с материалами, даже при включенном аппаратном ускорении, стоит переключиться с wayland сессии на x11 сессию.
