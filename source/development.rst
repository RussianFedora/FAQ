...
Внимание! Если в репозитории или глобально включена GPG-подпись коммитов, то в ней будет указана текущая дата и время. Решить это можно лишь изменив :ref:`настройки всей системы <set-datetime>`.
