...
Для передачи параметра необходимо в меню загрузчика Grub 2 выбрать нужную загрузочную опцию и нажать клавишу **E** на клавиатуре для перехода в режим редактирвоания.

В открывшемся редакторе найдите строку, которая начинается со слова **linux**, перейдите в ее конец. Отступите пробел от последнего символа и добавьте нужный параметр. Если параметров несколько, используйте пробел в качестве разделителя между ними.

Для начала загрузки нажмите сочетание **Ctrl + X** на клавиатуре. 
