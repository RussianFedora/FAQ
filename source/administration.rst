...
.. index:: linux, kernel, modprobe, module
.. _modprobe-sberr:
...
Необходимо либо отключить Secure Boot в настройках UEFI компьютера, либо подписать модуль действительной цифровой подписью.
