...
Попытаемся смонтировать повреждённый раздел с файловой системой BTRFS:
...
Сделаем копию сохранившиеся данные с раздела на другой накопитель (например на USB, смонтированный как **/media/external**):

.. code-block:: text

    sudo restore /dev/sda2 /media/external
