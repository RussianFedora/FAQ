...
По умолчанию пакет freetype в Fedora собран без поддержки субпиксельного сглаживания, поэтому чтобы получить качественный рендеринг шрифтов, необходимо подключить репозиторий RPM Fusion и установить из него специальную freeworld версию:

.. code-block:: bash

    sudo dnf install freetype-freeworld

После этого нужно разрешить использование LCD фильтров, создав символическую ссылку на файл **11-lcdfilter-default.conf** в каталоге **/etc/fonts/conf.d**:
