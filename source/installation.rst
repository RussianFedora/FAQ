...
Начиная с Fedora 33, в редакции Workstation, данная файловая система применяется для установки по умолчанию.
...
Недостатки:
  ...
  * без использования флага ``nodatacow`` очень сильно проседает производительность баз СУБД, а также виртуальных машин.
