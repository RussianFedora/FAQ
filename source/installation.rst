...
Зададим следующий параметр ядра:
...
Теперь откроем файл ``/etc/vconsole.conf`` в текстовом редакторе и заменим FONT на правильное значение для активации правильного шрифта:
