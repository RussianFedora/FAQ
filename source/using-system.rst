...
Установим новую дату без изменения времени:

.. code-block:: text

    sudo date --set="01 May 2023"

Установим одновременно дату и время, записанное в формате :ref:`Universal Coordinated Time <system-time-utc>`:

.. code-block:: text

    sudo date --utc --set="01 May 2023 00:00:00"
