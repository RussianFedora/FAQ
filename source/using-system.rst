...
.. _app_network_disable:

Как запретить приложению доступ в сеть?
========================================================================

Иногда возникает необходимость ограничить какому-либо приложению доступ в интернет. Простейшим решением является запуск требуемого приложения таким образом:

.. code-block:: text

    unashare -r -n <application>
