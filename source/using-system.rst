...
Как мне проверить ФС в составе LVM?
=======================================
...
Как мне проверить ФС при использовании классических разделов?
================================================================
...
.. index:: filesystem, выбор файловой системы
.. _fs-selection:
...
.. index:: filesystem, выбор файловой системы, BTRFS
.. _fs-btrfs:
