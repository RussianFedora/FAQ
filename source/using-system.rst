...
Просто расставьте '2' в шестом поле в файле '/etc/fstab' для нужных, а лучше - всех, ФС ('1' для /, как сказано в документации 'man fstab'), и ребутнитесь. И не надо беспокоиться ни о типах файловых систем, ни о LUKS томах, ни об отмонтировании корневой и хомяка. За результатами проверьте после загрузки 'journalctl -b'.
